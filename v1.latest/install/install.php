...
// 如要預先新增記錄，定義於此
$a_record[] = "INSERT INTO film(filmyear, pub_date, title_c, title_e, area, rate, key_wiki, key_imdb, key_dban, key_note, tag_cast, tag_note, tag_spec, tag_type, poster, remark) VALUES (
              '2022', '2022-03-01', '蝙蝠俠', 'The Batman', '美', 7, '蝙蝠俠_(2022年電影)', 'tt1877830', '6424756', 'AelkHtUARUit1ijn__7e8w', '@羅伯·派汀森', '#蝙蝠俠', '!蝙蝠俠系列', '電影', 'default.jpg', 'A') ";
$a_record[] = "INSERT INTO film(filmyear, pub_date, title_c, title_e, area, rate, key_wiki, key_imdb, key_dban, key_note, tag_cast, tag_note, tag_spec, tag_type, poster, remark) VALUES (
              '2008', '2008-07-14', '黑暗騎士', 'The Dark Knight', '美', 9, '黑暗騎士', 'tt0468569', '1851857', 'g3X0azQ1TdWbbZTWXoPOGw', '@克里斯多福·諾蘭 @克里斯汀·貝爾 @希斯·萊傑 @摩根·費里曼', '#蝙蝠俠', '!蝙蝠俠系列', '電影', 'default.jpg', 'B') ";
...
<P><a href="import_csv.php">匯入資料 (注意：按下即執行，需預先準備好 data.csv 檔案)</a></p>
<P><a href="upload_input.php">上傳檔案後匯入資料</a></p>
<P><a href="export_csv.php">資料匯出存檔 (不含 uid 欄位)</a></p>
